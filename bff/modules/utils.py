    ...
    if 'geo_latitude' in cloud and 'geo_longitude' in cloud:
        try:
            ...
            copy['distance'] = haversine(
                lat1=latitude, lon1=longitude, lat2=cloud['geo_latitude'], lon2=cloud['geo_longitude'])
            return copy
        except:
            pass
    return cloud
...
def enrich_clouds_with_distance(latitude: Optional[str], longitude: Optional[str], clouds: List[Cloud]) -> List[Cloud]:
